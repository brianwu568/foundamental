...
class BamlSyncClient:
    ...
    def EvalBrandMatch(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvalBrandMatch", args={
    ...
    def EvalBrandMatchBatch(self, text: str,brands: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvalBrandMatchBatch", args={
    ...
    def EvalBrandMatchOllama(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvalBrandMatchOllama", args={
                "text": text,"brand_name": brand_name,"brand_aliases": brand_aliases,
            })
            return typing.cast(types.BrandMatchResult, result.cast_to(types, types, stream_types, False, __runtime__))
    def EvalOutput(self, expected: str,actual: str,criteria: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvalOutput", args={
    ...
    def EvalOutputOllama(self, expected: str,actual: str,criteria: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvalOutputOllama", args={
                "expected": expected,"actual": actual,"criteria": criteria,
            })
            return typing.cast(types.EvalResult, result.cast_to(types, types, stream_types, False, __runtime__))
    ...
    def RankEntitiesWithSourcesOllama(self, query: str,k: int,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="RankEntitiesWithSourcesOllama", args={
                "query": query,"k": k,
            })
    ...
    def RankEntitiesWithSourcesOpenAI(self, query: str,k: int,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="RankEntitiesWithSourcesOpenAI", args={
                "query": query,"k": k,
            })
            return typing.cast(types.RankingResultWithSources, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def EvalBrandMatch(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BrandMatchResult, types.BrandMatchResult]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvalBrandMatch", args={
            "text": text,"brand_name": brand_name,"brand_aliases": brand_aliases,
        })
        return baml_py.BamlSyncStream[stream_types.BrandMatchResult, types.BrandMatchResult](
          result,
    ...
    def EvalBrandMatchBatch(self, text: str,brands: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BrandMatchBatchResult, types.BrandMatchBatchResult]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvalBrandMatchBatch", args={
            "text": text,"brands": brands,
        })
        return baml_py.BamlSyncStream[stream_types.BrandMatchBatchResult, types.BrandMatchBatchResult](
          result,
    ...
    def EvalBrandMatchOllama(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvalBrandMatchOllama", args={
            "text": text,"brand_name": brand_name,"brand_aliases": brand_aliases,
        })
        return baml_py.BamlSyncStream[stream_types.BrandMatchResult, types.BrandMatchResult](
          result,
    ...
    def EvalOutput(self, expected: str,actual: str,criteria: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.EvalResult, types.EvalResult]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvalOutput", args={
            "expected": expected,"actual": actual,"criteria": criteria,
        })
        return baml_py.BamlSyncStream[stream_types.EvalResult, types.EvalResult](
          result,
    ...
    def EvalOutputOllama(self, expected: str,actual: str,criteria: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvalOutputOllama", args={
            "expected": expected,"actual": actual,"criteria": criteria,
        })
        return baml_py.BamlSyncStream[stream_types.EvalResult, types.EvalResult](
          result,
    ...
    def RankEntitiesWithSourcesOllama(self, query: str,k: int,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.RankingResultWithSources, types.RankingResultWithSources]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="RankEntitiesWithSourcesOllama", args={
            "query": query,"k": k,
        })
        return baml_py.BamlSyncStream[stream_types.RankingResultWithSources, types.RankingResultWithSources](
          result,
    ...
    def RankEntitiesWithSourcesOpenAI(self, query: str,k: int,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="RankEntitiesWithSourcesOpenAI", args={
            "query": query,"k": k,
        })
        return baml_py.BamlSyncStream[stream_types.RankingResultWithSources, types.RankingResultWithSources](
          result,
...
class BamlHttpRequestClient:
    ...
    def EvalBrandMatch(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvalBrandMatch", args={
            "text": text,"brand_name": brand_name,"brand_aliases": brand_aliases,
        }, mode="request")
        return result
    def EvalBrandMatchBatch(self, text: str,brands: typing.List[str],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvalBrandMatchBatch", args={
            "text": text,"brands": brands,
        }, mode="request")
        return result
    def EvalBrandMatchOllama(self, text: str,brand_name: str,brand_aliases: typing.List[str],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvalBrandMatchOllama", args={
            "text": text,"brand_name": brand_name,"brand_aliases": brand_aliases,
        }, mode="request")
        return result
    def EvalOutput(self, expected: str,actual: str,criteria: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvalOutput", args={
            "expected": expected,"actual": actual,"criteria": criteria,
        }, mode="request")
        return result
    def EvalOutputOllama(self, expected: str,actual: str,criteria: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvalOutputOllama", args={
            "expected": expected,"actual": actual,"criteria": criteria,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
    ...
    def RankEntitiesWithSourcesOllama(self, query: str,k: int,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="RankEntitiesWithSourcesOllama", args={
            "query": query,"k": k,
        }, mode="request")
        return result
    def RankEntitiesWithSourcesOpenAI(self, query: str,k: int,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="RankEntitiesWithSourcesOpenAI", args={
            "query": query,"k": k,
        }, mode="request")
        return result
